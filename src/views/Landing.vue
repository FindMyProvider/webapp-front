            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="display-3  text-white">FindMyProvider <br><br>
                                    <span>Trouve l'hébergeur qui te correspond.</span>
                                </h1>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <base-input alternative placeholder="Ton budget" addon-right-icon="fa fa-eur"></base-input>
                                    </div>                                    
                                </div>
